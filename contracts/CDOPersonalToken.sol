    ...
    ERC20Burnable
{
     ...
     */
    constructor() ERC20("CDO Personal Token", "CDOPT") {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(
            ...
            "CDOPersonalToken: must have minter role to mint"
        );
    ...
    function pause() public virtual {
        require(
            ...
            "CDOPersonalToken: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "CDOPersonalToken: must have pauser role to unpause"
        );
        _unpause();
    }
